...
export default function AdminNewWordPage() {
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const { error } = await supabase.from("dictionary_words").insert({
        ...
        description: description.trim() || `Mục từ "${word.trim()}" trong từ điển CHẠM.`,
        sign_steps: [
          "Quan sát video minh họa ký hiệu.",
  ...
  return (
    <div className="p-6 sm:p-8">
      ...
      <h1 className="mb-6 text-3xl font-black text-slate-950">Thêm từ mới</h1>
