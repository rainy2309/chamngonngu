    ...
    <main className="flex-1 bg-gradient-to-b from-blue-50 to-white px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 text-center">
          <p className="font-black uppercase tracking-[0.25em] text-blue-500">Về dự án</p>
          <h1 className="mt-3 text-4xl font-black text-slate-950 sm:text-5xl">CHẠM là gì?</h1>
          <p className="mx-auto mt-5 max-w-3xl text-xl leading-9 text-slate-600">CHẠM là nền tảng web giúp người dùng học từ vựng ngôn ngữ ký hiệu Việt Nam thông qua thẻ trực quan, tìm kiếm, bài học và hoạt động quiz.</p>
        </div>
